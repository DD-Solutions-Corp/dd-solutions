...
<div id="mainVisualWrap" class="flex fadeInUp animated">
    <div id="mainVisual">
        ...
        $hero_image = get_option('dd_solutions_hero_image', get_template_directory_uri() . '/img/top/mainimage.jpg');
        $hero_image_sp = get_option('dd_solutions_hero_image_sp', get_template_directory_uri() . '/img/top/mainimage_sp.jpg');
        ?>
        <img src="<?php echo esc_url($hero_image); ?>" alt="" class="pcONspOFF">
        <img src="<?php echo esc_url($hero_image_sp); ?>" alt="" class="pcOFFspON">
        <div class="mainCatch">
    ...
    <div class="wrapper">
        ...
        <div class="f-wrap-AC">
            <div class="f-item1-2 flex fadeInLeft animated">
                <p><img src="<?php echo get_template_directory_uri(); ?>/img/top/1.jpg" alt=""></p>
            </div>
...
<section class="bgColor flex fadeInUp animated">
    <div class="wrapper">
        ...
        <div class="f-wrap-AC f-row-reverse">
            <div class="f-item1-2 flex fadeInRight animated">
                <p><img src="<?php echo get_template_directory_uri(); ?>/img/top/2.jpg" alt=""></p>
            </div>

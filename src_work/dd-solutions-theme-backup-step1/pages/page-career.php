    ...
    <section class="bgColor flex fadeInUp animated">
      <div class="wrapper">
        ...
        <div class="contPad contact">
          ...
          <form id="careerForm" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
              ...
              $('#careerForm').on('submit', function(e) {
                  ...
                  $.ajax({
                      ...
                      success: function(response) {
                          if (response.success) {
                              $('#careerMessage').html('<p style="color:green;">' + response.data.message + '</p>');
                              $('#careerForm')[0].reset();
                          } else {
                              $('#careerMessage').html('<p style="color:red;">' + response.data.message + '</p>');
                          }
                      }
                  });
              });
